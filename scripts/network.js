  ...
  try {
    ...
    if (data.result && data.result.length === 64) {
      ...
      if (domAddress1s.value !== donationAddress)
          ...
          domTxOutput.innerHTML = ('<h4 style="color:green">Thank you for supporting Pcoin Web Wallet! 💜💜💜<br><span style="font-family:mono !important">' + data.result + '</span></h4>');
...
// pcoin Analytics: if you are a user, you can disable this FULLY via the Settings.
// ... if you're a developer, we ask you to keep these stats to enhance upstream development,
// ... but you are free to completely strip PWW of any analytics, if you wish, no hard feelings.
var submitAnalytics = function (strType, cData = {}) {
    ...
    request.open('POST', "https://pcoin.dev/pww/statistic", true);

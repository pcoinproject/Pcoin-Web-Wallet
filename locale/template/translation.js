var translation = {
    ...
    footerBuiltWithPcoinLabs: "",    //Built with 💜 by PCOIN Dev
    ...
    dCardOneDesc: "",               //This will create a new, random PCOIN wallet that will contain no initial funds, you may transfer to-and-from this wallet with ease.
    dCardOneButton: "",             //Create A New Wallet

    dCardTwoTitle: "",              //Create a new
    dCardTwoSubTitle: "",           //Vanity Wallet
    dCardTwoDesc: "",               //This will create a PCOIN wallet with a customized prefix of your choosing, requiring more processing power to generate such addresses, it is recommended to generate a prefix of less than 6 characters, for example: "DAD" is a possible address prefix.
    dCardTwoButton: "",             //Create A Vanity Wallet

    dCardThreeTitle: "",            //Access your
    dCardThreeSubTitle: "",         //Hardware Wallet
    dCardThreeDesc: "",             //This will help managing the PCOIN wallet on your ledger. Notice that the private key will remain safe in your hardware device
    dCardThreeButton: "",           //Access my hardware wallet

    dCardFourTitle: "",             //Go to
    dCardFourSubTitle: "",          //My Wallet
    dCardFourDesc: "",              //This will import a PCOIN wallet that you hold via it's private key, loading the address and pulling your existing balance, if any, from an explorer node.
    dCardFourSubDesc:"",            //*Note: PWW developers can NOT access your wallet, this wallet runs purely in YOUR browser using JavaScript.
    ...
    stakeSubTitle:"",               //Please be aware PWW Cold Staking is a new, slightly experimental feature, it may be unstable, and is currently slow. Please have patience when using this feature, and wait for block confirmations before actions and balances are shown on-screen.
    ...
    settingsPcoinNode:"",            //Choose a PCOIN node:
    ...
    INVALID_ADDRESS: "",             //<b>Invalid PCOIN address!</b><br> {address}
    ...
    BAD_ADDR_LENGTH: "",             //'<b>Invalid PCOIN address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX: "",             //'<b>Invalid PCOIN address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET: "",         //"<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the PCOIN app",

var uwu_translation = {
    ...
    footerBuiltWithPcoinLabs: "Built with wuv by PCOIN Wabs❣",    //Built with 💜 by PCOIN Dev
    footerGithubLink: "",           //Pcoin Web Wallet

    // Dashboard
    dashboardTitle: "Dashbowod",             //Dashboard
    dCardOneTitle: "Cweate a",              //Create a
    dCardOneSubTitle: "New Wawwet!",           //New Wallet
    dCardOneDesc: "Dis will cweate a new, wandom, PCOIN wawwet dat will contain no initial funds, uwu. Yowou may twansfer to-and-fwom dis wawwet with ease! ",               //This will create a new, random PCOIN wallet that will contain no initial funds, you may transfer to-and-from this wallet with ease.
    ...
    dCardThreeDesc: "Dis will help managing da PCOIN wawwet on your wedger. Nowotice dat de pwivate key will wemaine safe in yowour hawdware device",             //This will help managing the PCOIN wallet on your ledger. Notice that the private key will remain safe in your hardware device
    ...
    dCardFourDesc: "Dis will impowt a PCOIN wawwet dat you howd via it's pwivate key, woading da adwess and puwwing your existing bawance, if any, fwom an expwowor node.",              //This will import a PCOIN wallet that you hold via it's private key, loading the address and pulling your existing balance, if any, from an explorer node.
    dCardFourSubDesc:"♡Nowote: PWW devewepers can NOT access yowour wawwet, dis wawwet wuns purewy in YOWOUR bwowser using JavaScwipt.",            //*Note: PWW developers can NOT access your wallet, this wallet runs purely in YOUR browser using JavaScript.
    ...
    stakeSubTitle:"Pwease be aware PWW Cold staking is new, slightly expewimental, feature. It may be unstabwe, and is cuwwentwy slow. Pwease have patience when using dis feature, and wait for bwock confiwmations befowore actions and bawances are showown on-scween.",               //Please be aware PWW Cold Staking is a new, slightly experimental feature, it may be unstable, and is currently slow. Please have patience when using this feature, and wait for block confirmations before actions and balances are shown on-screen.
    ...
    settingsPcoinNode:"Chowose a PCOIN nowode pwease:",            //Choose a PCOIN node:
    ...
    time_to_sync:"The time in seconds it took for PWW to last synchronise.♡",
    ...
    NEW_PASSWORD_SUCCESS:"<b>Yowou\'re Secuwed!</b><br>Good Job, PCOIN Pogchamp!",         //'<b>You\'re Secured! 🔐</b><br>Nice stuff.',
    ...
    INVALID_ADDRESS: "<b>Invawed PCOIN addwess baka</b><br> {address} ",            //<b>Invalid PCOIN address!<b><br> {address}
    ...
    BAD_ADDR_LENGTH:"<b>Invawed PCOIN addwess!</b><br>Bad wength ({addressLength})",              //'<b>Invalid PCOIN address!<b><br>Bad length ({addressLength})',
    BAD_ADDR_PREFIX:"<b>Invawed PCOIN addwess! Baka!</b><br>Bad pwefix {address} (Should start with {addressPrefix})",              //'<b>Invalid PCOIN address!<b><br>Bad prefix {address} (Should start with {addressPrefix})',
    ...
    WALLET_HARDWARE_WALLET: "<b>Hawdware wawwet ready!</b><br>Pwease keep your {hardwareWallet} pwugged in, unwocked, and in da PCOIN app ♥",         //"<b>Hardware wallet ready!</b><br>Please keep your {hardwareWallet} plugged in, unlocked, and in the PCOIN app",
